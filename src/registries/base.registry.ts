...
import type {
  BaseRegistryOptions as IBaseRegistryOptions,
 ...
 * ```
 */
export class BaseRegistry<T> implements ICollection<T> {
  /**
   ...
   */
  protected validateBeforeAdd?: (key: string, item: T) => IValidationResult;
   ...
   */
  constructor(options: IBaseRegistryOptions<T> = {}) {
