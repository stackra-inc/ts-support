/**
 * @fileoverview Fluent string wrapper for chainable string operations.
 *
 * Provides a fluent interface for all Str methods, allowing method chaining.
 * Similar to Laravel's Stringable class.
 *
 * @module str/stringable
 * @category Strings
 *
 * @example
 * ```typescript
 * import { Stringable } from '@stackra/ts-support';
 *
 ...
 *   .toString(); // 'HelloWorld'
 *
 * const slug = new Stringable('  Hello World!  ')
 *   .trim()
 *   .slug()
 *   .toString(); // 'hello-world'
 * ```
 */
import { Str } from "./str.service";
