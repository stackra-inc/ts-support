/**
 * @fileoverview Laravel-style Collection class for arrays.
 *
 * Wraps `collect.js` to provide a fluent, chainable API for array
 * manipulation. Mirrors Laravel's `Illuminate\Support\Collection`.
 *
